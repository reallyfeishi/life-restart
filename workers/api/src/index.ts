...
变化幅度由当前属性值决定（S型成长曲线）：
- 属性 0-3（初学者）：进步缓慢，+0到+1（基础薄弱，需要积累）
- 属性 4-8（成长期）：进步较快，+0到+2（黄金成长期，事件影响明显）
- 属性 9-12（成熟期）：进步放缓，+0到+1（已有一定基础，提升需要更大契机）
- 属性 13-15（瓶颈期）：极难提升，大部分事件+0，偶尔+1（接近上限，几乎停滞）

四个属性的变化方向：
- **智力**：学习、读书、拜师、解谜、思考、研究、辩论、悟道 → 正增长；厌学、荒废、不思进取、被误导 → 负增长
- **体质**：锻炼、练武、劳作、饮食规律、修行、调养 → 正增长；生病、受伤、挨饿、劳累过度、暴饮暴食 → 负增长
- **颜值**：贵人指点仪态、精心打扮、美容奇遇、气质蜕变、青春焕发 → 正增长；遭遇毁容、风吹日晒、不修边幅、容颜衰老 → 负增长
- **家境**：获得遗产、投资成功、贵人资助、经商获利、意外之财 → 正增长；家道中落、被骗、投资失败、灾祸、挥霍 → 负增长
...
9. 在重要人生节点（如升学、就业、恋爱、结婚、创业、重大抉择等，约30%概率）生成选择事件
