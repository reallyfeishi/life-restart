  ...
  return (
    <div className="flex flex-col h-dvh bg-bg-page px-6 py-6">
      <div className="text-center mb-6 mt-4 flex-shrink-0">
        ...
        <h2 className="font-serif-sc text-2xl font-bold text-text-title mb-1">人生结束</h2>
      ...
      <div className="flex-1 overflow-hidden space-y-3">
        {/* Score card */}
        <div className="border border-[rgba(0,0,0,0.08)] rounded-card p-6 text-center bg-bg-card">
          ...
          <div className="text-sm text-text-aux mb-3">{state.deathReason}</div>
        ...
        {/* Life review */}
        <div className="border border-[rgba(0,0,0,0.08)] rounded-card p-4 bg-bg-card">
          ...
          <div className="border border-[rgba(0,0,0,0.08)] rounded-card p-4 bg-bg-card">
            ...
            <div className="flex flex-wrap gap-2">
              {state.unlockedAchievements.map((id: string) => (
                <span key={id} className="text-xs px-2 py-1 rounded-tag bg-bg-page text-text-body border border-[rgba(0,0,0,0.06)]">
      ...
      <div className="flex gap-3 mt-4 pb-16 flex-shrink-0">
        <button
          className="flex-1 min-h-[46px] px-6 rounded-btn font-semibold text-[15px] transition-colors duration-fast cursor-pointer select-none text-white bg-[#a85656]"
          onClick={resetGame}
        >
          再来一局
        </button>
